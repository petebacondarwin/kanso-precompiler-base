...
## Usage
Add the package as a dependency of your own preocompiler package, so that when some one uses your libary the precompiler-base package will be installed too.
